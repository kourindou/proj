...
class Boy:
    ...
    def __init__(self):
        ...
        self.my = 0
        self.angle=0
        self.bar=load_image('../res/aaa.png')
        if Boy.image == None:
    ...
    def draw(self):
        ...
        self.bar.composite_draw(self.angle,'',self.x, self.y)

    def update(self):
        self.state.update(self)
        self.angle=math.atan2(self.x - self.mx, self.my - self.y)+1.55
    ...
    def fire_ball(self, big):
        ...
        ballSpeed = self.mx*0.015

        ySpeed = self.my*0.015
        if big: ySpeed *= 0.75
